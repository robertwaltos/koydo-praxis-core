// Auto-generated shim — re-exports from @/lib/praxis-core/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _praxis_core_Config } from "@/lib/praxis-core/config";
import { EXAM_CONFIG as _raw } from "@/lib/praxis-core/config";
