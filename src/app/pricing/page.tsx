...
export const metadata: Metadata = {
  title: "Pricing — Praxis Core Premium",
  description: "Unlock unlimited Praxis Core practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=praxis-core&cadence=annual`;
